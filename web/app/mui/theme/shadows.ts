...
const createCustomShadow = (color: string) => {
  ...
  return {
    ...
    primary: `0 8px 16px 0 ${alpha(
      (<SimplePaletteColorOptions>palette.primary).main,
      0.24
    )}`,
    secondary: `0 8px 16px 0 ${alpha(
      (<SimplePaletteColorOptions>palette.secondary).main,
      0.24
    )}`,
    info: `0 8px 16px 0 ${alpha(
      (<SimplePaletteColorOptions>palette.info).main,
      0.24
    )}`,
    success: `0 8px 16px 0 ${alpha(
      (<SimplePaletteColorOptions>palette.success).main,
      0.24
    )}`,
    warning: `0 8px 16px 0 ${alpha(
      (<SimplePaletteColorOptions>palette.warning).main,
      0.24
    )}`,
    error: `0 8px 16px 0 ${alpha(
      (<SimplePaletteColorOptions>palette.error).main,
      0.24
    )}`,
  };
};
